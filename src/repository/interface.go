...
type PgSQLRepository interface {
    ...
    UpdateByFieldsWhere(obj interface{}, fields map[string]interface{}, query string, args ...interface{}) error
    ...
    // Transaction methods
    BeginTransaction() PgSQLRepository  // ⚠️ Returns interface, not concrete type
    Commit() error
    Rollback() error
}