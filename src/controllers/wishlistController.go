...
func (w *WishlistController)AddToWishlist(c *gin.Context){
	...
	c.JSON(constant.CREATED,gin.H{"message":"Product added to wishlist success"})
}
...
func(w *WishlistController)IsInWishlist(c *gin.Context){
	...
	c.JSON(constant.SUCCESS,gin.H{"is in wishlist":isInWishlist})
}
...
func(w *WishlistController)ClearWishlist(c *gin.Context){
	...
	c.JSON(constant.SUCCESS,gin.H{"message":"Wishlist cleaered successfully"})
}
